function gstcalc(){
    ...
    if(ps==0){
        ...
        document.getElementById("tr2").innerHTML="<td>SGST "+SGST+" %</td><td></td>"+"</td><td></td>"
        +total*SGST/100+"</td>";

        document.getElementById("tr3").innerHTML="<td>CGST" +CGST+" %</td><td></td>"+"</td><td></td>Rs"
        +total*CGST/100+"</td>";
        ...
        document.getElementById("tr3").innerHTML="<td>IGST" +IGST+" %</td><td></td>"+"</td><td></td>Rs"
        +total*IGST/100+"</td>";
